...
import { generateMeritocracyMD, downloadMarkdown } from '../lib/markdownExport';
...
export default function MeritocracyResultsReport() {
  ...
  return (<div className="space-y-8">
    ...
    <div className="text-center pb-10"><div className="flex items-center justify-center gap-4 flex-wrap">
      ...
      <button onClick={() => downloadMarkdown(generateMeritocracyMD(r), '优绩主义程度测评报告.md')} className="px-6 py-3 rounded-lg font-semibold border-2 border-gray-300 text-gray-700 hover:bg-gray-100 transition-colors">📥 下载MD报告</button>
