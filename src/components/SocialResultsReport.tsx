...
import { generateSocialMD, downloadMarkdown } from '../lib/markdownExport';
...
export default function SocialResultsReport() {
  ...
  const { chartRef, downloadPoster } = usePosterDownload('社交风格雷达图.png');
  return (<div className="space-y-8">
    ...
    <div className="card"><h2 className="text-lg font-bold text-gray-800 mb-4">4种社交风格完整排序</h2><div style={{ height: 300 }}><ReactECharts ref={chartRef} option={barOpt(r)} style={{ height: '100%' }} /></div></div>
    ...
    <div className="text-center pb-10">
      <div className="flex items-center justify-center gap-4 flex-wrap">
        <a href={`${import.meta.env.BASE_URL}social`} className="btn-primary inline-block">重新测评</a>
        <button
          onClick={() => downloadMarkdown(generateSocialMD(r), '社交风格测评报告.md')}
