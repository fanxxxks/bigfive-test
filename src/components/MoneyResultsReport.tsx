...
export default function MoneyResultsReport() {
  ...
  return (<div className="space-y-8">
    ...
    <div className="card"><h2 className="text-lg font-bold text-gray-800 mb-4">5种金钱人格完整排序</h2><div style={{ height: 300 }}><ReactECharts option={barOpt(r)} style={{ height: '100%' }} /></div></div>
